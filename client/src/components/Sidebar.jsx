...
const Sidebar = () => {
  ...
  return (
    <div className='h-full shadow-xl shadow-black/100 w-1/5 bg-[#2274A5] sticky top-0'>
        <div className='h-2/5 mt-2 w-full flex flex-col justify-center'>
            ...
            <div className='h-1/2 text-white self-center content-center text-2xl font-bold p-1'>{userName}</div>
        </div>
